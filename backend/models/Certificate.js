...
const certificateSchema = new mongoose.Schema(
  {
    ...
    // Optional now, because admin can create/edit a dummy/manual certificate also
    ...
    instituteName: {
      type: String,
      trim: true,
      default: 'Bengal Institute of IT & Technology'
    },
    officeAddress: {
      type: String,
      trim: true,
      default: 'H.O. & Reg. Office : Midnapore, West Bengal'
    },
